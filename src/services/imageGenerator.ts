...
export class ImageGenerator {
        ...
        if (logoPath) {
            try {
                const logo = await sharp(logoPath)
                    .resize(145, 145, { fit: 'contain', background: { r: 0, g: 0, b: 0, alpha: 0 } })
                    .png()
                    .toBuffer();
    ...
    async generatePlayoffsImage(data: PlayoffData): Promise<Buffer> {
        ...
        <svg width="${width}" height="${height}" xmlns="http://www.w3.org/2000/svg">
            ...
            <circle cx="${width / 2}" cy="250" r="65" fill="${COLORS.darkBg}" opacity="0.9"/>
            <circle cx="${width / 2}" cy="250" r="65" fill="none" stroke="${COLORS.primary}" stroke-width="3"/>
            ...
            <line x1="630" y1="455" x2="850" y2="455" stroke="${COLORS.cyan}"
                stroke-width="3" stroke-dasharray="10,5" opacity="0.5"/>
                
            <line x1="630" y1="725" x2="850" y2="725" stroke="${COLORS.cyan}"
                stroke-width="3" stroke-dasharray="10,5" opacity="0.5"/>
                
            <line x1="850" y1="455" x2="850" y2="590" stroke="${COLORS.cyan}"
                stroke-width="3" stroke-dasharray="10,5" opacity="0.5"/>
                
            <line x1="850" y1="725" x2="850" y2="590" stroke="${COLORS.cyan}"
                stroke-width="3" stroke-dasharray="10,5" opacity="0.5"/>
                
            <line x1="850" y1="590" x2="1250" y2="590" stroke="${COLORS.primary}"
                stroke-width="4" stroke-dasharray="10,5" opacity="0.6"/>
                
            
            ${drawMatch(250, 375, data.semifinals[0].teamA, data.semifinals[0].teamB,
            data.semifinals[0].winner, 'SEMIFINAL 1')}
            
            ${drawMatch(250, 645, data.semifinals[1].teamA, data.semifinals[1].teamB,
                data.semifinals[1].winner, 'SEMIFINAL 2')}
            
            ${drawMatch(1250, 510, data.final.teamA, data.final.teamB,
